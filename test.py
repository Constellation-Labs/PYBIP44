...
master_key = HDPrivateKey.master_key_from_mnemonic('obscure worry home pass museum toss else accuse limb hover denial alpha', 'dag')
root_key = HDPrivateKey.from_path(master_key,"m/44'/137'/0'")
for i in range(10):
    print("Index %s:" % i)
